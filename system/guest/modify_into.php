...
$f_rank=strip_tags($_POST['f_ranku']);
if($f_rank == ""){
...
$result = mysql_query("UPDATE guest SET id='$id',f_date='$f_date',f_tanto='$f_tanto',f_rank='$f_rank',f_name='$f_name',f_yomi='$f_yomi',f_tel='$f_tel',f_mail='$f_mail',f_gyousyu='$f_gyousyu',f_meigi='$f_meigi',f_kubun='$f_kubun',f_kubun_biko='$f_kubun_biko',f_trigger='$f_trigger',f_trigger_biko='$f_trigger_biko',f_jiki='$f_jiki',f_visit='$f_visit',f_visit_biko='$f_visit_biko',f_rent='$f_rent',f_p1='$f_p1',f_p2='$f_p2',f_cost='$f_cost',f_madori='$f_madori',f_pet1='$f_pet1',f_pet2='$f_pet2',f_pet_biko='$f_pet_biko',f_people='$f_people',f_age='$f_age',f_startliving_year='$f_startliving_year',f_startliving_month='$f_startliving_month',f_startliving_day='$f_startliving_day',f_startliving='$f_startliving',f_startliving_biko='$f_startliving_biko',f_area='$f_area',f_required='$f_required',f_required_biko='$f_required_biko',f_rank1='$f_rank1',f_rank2='$f_rank2',f_rank3='$f_rank3',f_rank4='$f_rank4' WHERE id='$id';", $db);
...
<link rel="stylesheet" type="text/css" href="guest.css?1122113" media="screen,tv" />
</head>

<body class="guest reception complete">
...
<div class="uestion_container clearfix">
<div class="uestion_title">ランク</div>
<div class="uestion_contents">
<?php
